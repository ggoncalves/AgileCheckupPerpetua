...
/**
 * Converter for QuestionV2 object to/from DynamoDB String attribute.
 * Handles V2 entities with Instant-based timestamps.
 */
public class QuestionV2AttributeConverter implements AttributeConverter<QuestionV2> {
    ...
    @Override
    public AttributeValue transformFrom(QuestionV2 input) {
        if (input == null) {
    ...
    @Override
    public QuestionV2 transformTo(AttributeValue input) {
        ...
        try {
            return OBJECT_MAPPER.readValue(content, QuestionV2.class);
        } catch (JsonProcessingException e) {
    ...
    @Override
    public EnhancedType<QuestionV2> type() {
        return EnhancedType.of(QuestionV2.class);
    }
