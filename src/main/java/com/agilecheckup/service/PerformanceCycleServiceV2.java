...
@Log4j2
@Singleton
public class PerformanceCycleServiceV2 extends AbstractCrudServiceV2<PerformanceCycleV2, PerformanceCycleRepositoryV2> {

    private final PerformanceCycleRepositoryV2 performanceCycleRepository;
    private final CompanyServiceV2 companyServiceV2;

    @Inject
    public PerformanceCycleServiceV2(PerformanceCycleRepositoryV2 performanceCycleRepository, CompanyServiceV2 companyServiceV2) {
