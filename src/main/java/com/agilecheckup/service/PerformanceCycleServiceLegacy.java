...
public class PerformanceCycleServiceLegacy extends AbstractCrudService<PerformanceCycle, AbstractCrudRepository<PerformanceCycle>> {
  ...
  @Inject
  public PerformanceCycleServiceLegacy(PerformanceCycleRepository performanceCycleRepository, CompanyServiceLegacy companyService) {
