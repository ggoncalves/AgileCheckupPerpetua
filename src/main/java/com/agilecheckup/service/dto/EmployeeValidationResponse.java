...
public class EmployeeValidationResponse {
    ...
    public static EmployeeValidationResponse success(String message, String employeeAssessmentId, 
                                                    String name, String assessmentStatus) {
        return EmployeeValidationResponse.builder()
                .status("SUCCESS")
                .message(message)
    ...
    public static EmployeeValidationResponse info(String message, String employeeAssessmentId, 
                                                  String name, String assessmentStatus) {
        return EmployeeValidationResponse.builder()
                .status("INFO")
                .message(message)
