...
public class TeamServiceLegacy extends AbstractCrudService<Team, AbstractCrudRepository<Team>> {

  private final TeamRepository teamRepository;
  private final DepartmentService departmentService;

  @Inject
  public TeamServiceLegacy(TeamRepository teamRepository, DepartmentService departmentService) {
