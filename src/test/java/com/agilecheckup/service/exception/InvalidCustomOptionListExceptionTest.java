...
class InvalidCustomOptionListExceptionTest {
  ...
  void testMessage_Empty() {
    InvalidCustomOptionListException exception =
        new InvalidCustomOptionListException(InvalidCustomOptionListException.InvalidReasonEnum.OPTION_LIST_EMPTY
            , 2, 64);
  ...
  void testMessage_TooShort() {
    InvalidCustomOptionListException exception =
        new InvalidCustomOptionListException(InvalidCustomOptionListException.InvalidReasonEnum.OPTION_LIST_TOO_SHORT
            , 2, 64);
  ...
  void testMessage_EmptyText() {
    InvalidCustomOptionListException exception =
        new InvalidCustomOptionListException(InvalidCustomOptionListException.InvalidReasonEnum.OPTION_LIST_TEXT_EMPTY
            , 2, 64);
    assertEquals("Question option list text is empty.",
  ...
  void testMessage_TooBig() {
    InvalidCustomOptionListException exception =
        new InvalidCustomOptionListException(InvalidCustomOptionListException.InvalidReasonEnum.OPTION_LIST_TOO_BIG
            , 2, 64);
  ...
  void testMessage_InvalidOptionIds() {
    Integer[] array = {1, 1, 2};
    InvalidCustomOptionListException exception =
        new InvalidCustomOptionListException(InvalidCustomOptionListException.InvalidReasonEnum.INVALID_OPTIONS_IDS
            , array);
