...
class CompanyServiceV2Test extends AbstractCrudServiceTestV2<CompanyV2, CompanyRepositoryV2> {
    ...
    void createLegacy_shouldSucceedWithBasicFields() {
        ...
        // When
        Optional<CompanyV2> result = companyServiceV2.create(
    ...
    void updateLegacy_existingCompany_shouldSucceed() {
        ...
        // When
        Optional<CompanyV2> result = companyServiceV2.update(
            DEFAULT_ID,
            "0002",
