...
class DashboardAnalyticsServiceTest {
    ...
    void updateAssessmentMatrixAnalytics_WithValidAssessments_ShouldCalculateAndSaveAnalytics() {
        // Given
        EmployeeAssessmentV2 assessment1 = createMockEmployeeAssessment("emp1", TEAM_ID);
        EmployeeAssessmentV2 assessment2 = createMockEmployeeAssessment("emp2", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithMultipleTeams_ShouldCreateAnalyticsForEachTeam() {
        // Given
        EmployeeAssessmentV2 assessment1 = createMockEmployeeAssessment("emp1", "team1");
        EmployeeAssessmentV2 assessment2 = createMockEmployeeAssessment("emp2", "team2");
        List<EmployeeAssessmentV2> assessments = Arrays.asList(assessment1, assessment2);
    ...
    void updateAssessmentMatrixAnalytics_WithWordCloudData_ShouldGenerateWordCloud() {
        // Given
        EmployeeAssessmentV2 assessment = createMockEmployeeAssessment("emp1", TEAM_ID);
        List<EmployeeAssessmentV2> assessments = Collections.singletonList(assessment);
        
        AnswerV2 answer1 = createMockAnswer("This is excellent work and shows great improvement");
        AnswerV2 answer2 = createMockAnswer("The team collaboration needs improvement but overall good progress");
    ...
    void updateAssessmentMatrixAnalytics_WithCompletedAssessments_ShouldCalculateCorrectPercentages() {
        // Given
        EmployeeAssessmentV2 completedAssessment = createMockEmployeeAssessment("emp1", TEAM_ID);
        ...
        EmployeeAssessmentV2 inProgressAssessment = createMockEmployeeAssessment("emp2", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithNullTeamId_ShouldSkipAssessment() {
        // Given
        EmployeeAssessmentV2 assessmentWithoutTeam = createMockEmployeeAssessment("emp1", null);
        EmployeeAssessmentV2 assessmentWithTeam = createMockEmployeeAssessment("emp2", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithSingleEmployee_ShouldCalculateCorrectTotalScore() {
        ...
        EmployeeAssessmentV2 employee = createMockEmployeeAssessment("emp1", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithMultipleEmployeesSameTeam_ShouldCalculateAverageScore() {
        ...
        EmployeeAssessmentV2 emp1 = createMockEmployeeAssessment("emp1", TEAM_ID);
        emp1.getEmployeeAssessmentScore().setScore(100.0);
        
        EmployeeAssessmentV2 emp2 = createMockEmployeeAssessment("emp2", TEAM_ID);
        emp2.getEmployeeAssessmentScore().setScore(80.0);
        
        EmployeeAssessmentV2 emp3 = createMockEmployeeAssessment("emp3", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithMultipleTeams_ShouldCalculateOverallAverage() {
        ...
        EmployeeAssessmentV2 team1Emp1 = createMockEmployeeAssessment("team1_emp1", "team1");
        team1Emp1.getEmployeeAssessmentScore().setScore(120.0);
        
        EmployeeAssessmentV2 team1Emp2 = createMockEmployeeAssessment("team1_emp2", "team1");
        team1Emp2.getEmployeeAssessmentScore().setScore(80.0);
        
        EmployeeAssessmentV2 team2Emp1 = createMockEmployeeAssessment("team2_emp1", "team2");
        team2Emp1.getEmployeeAssessmentScore().setScore(60.0);
        
        EmployeeAssessmentV2 team2Emp2 = createMockEmployeeAssessment("team2_emp2", "team2");
    ...
    void updateAssessmentMatrixAnalytics_WithMixedCompletionStatus_ShouldOnlyCountCompleted() {
        ...
        EmployeeAssessmentV2 completedEmp1 = createMockEmployeeAssessment("completed1", TEAM_ID);
        completedEmp1.setAssessmentStatus(AssessmentStatus.COMPLETED);
        completedEmp1.getEmployeeAssessmentScore().setScore(90.0);
        
        EmployeeAssessmentV2 completedEmp2 = createMockEmployeeAssessment("completed2", TEAM_ID);
        completedEmp2.setAssessmentStatus(AssessmentStatus.COMPLETED);
        completedEmp2.getEmployeeAssessmentScore().setScore(70.0);
        
        EmployeeAssessmentV2 inProgressEmp = createMockEmployeeAssessment("inprogress", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithNoCompletedAssessments_ShouldHaveZeroAverage() {
        ...
        EmployeeAssessmentV2 inProgressEmp1 = createMockEmployeeAssessment("emp1", TEAM_ID);
        inProgressEmp1.setAssessmentStatus(AssessmentStatus.IN_PROGRESS);
        inProgressEmp1.setEmployeeAssessmentScore(null);
        
        EmployeeAssessmentV2 invitedEmp2 = createMockEmployeeAssessment("emp2", TEAM_ID);
    ...
    void updateAssessmentMatrixAnalytics_WithCompletedButUnscored_ShouldCountAsZero() {
        ...
        EmployeeAssessmentV2 scoredEmp = createMockEmployeeAssessment("scored", TEAM_ID);
        scoredEmp.getEmployeeAssessmentScore().setScore(123.0);
        
        EmployeeAssessmentV2 unscoredEmp1 = createMockEmployeeAssessment("unscored1", "team2");
        ...
        EmployeeAssessmentV2 unscoredEmp2 = createMockEmployeeAssessment("unscored2", "team2");
    ...
    void updateAssessmentMatrixAnalytics_WithNoPotentialScore_ShouldHandleGracefully() {
        // Given
        AssessmentMatrixV2 matrixWithoutPotentialScore = AssessmentMatrixV2.builder()
    ...
    private void setupMockEntities() {
        ...
        mockMatrix = AssessmentMatrixV2.builder()
                .id(ASSESSMENT_MATRIX_ID)
    ...
    private EmployeeAssessmentV2 createMockEmployeeAssessment(String employeeId, String teamId) {
    ...
    private List<AnswerV2> createMockAnswers() {
        AnswerV2 answer1 = createMockAnswer("Great teamwork and collaboration");
        AnswerV2 answer2 = createMockAnswer("Needs improvement in communication");
        return Arrays.asList(answer1, answer2);
    }

    private AnswerV2 createMockAnswer(String notes) {
    ...
    private CompanyV2 createMockCompany() {
    ...
    private PerformanceCycleV2 createMockPerformanceCycle() {
