...
class AddressV2AttributeConverterTest {

  private AddressV2AttributeConverter converter;
  private AddressV2 completeAddress;
  private String expectedJsonString;

  @BeforeEach
  void setUp() {
    converter = new AddressV2AttributeConverter();
  ...
  void shouldTransformJsonAttributeValueToCompleteAddress() {
    ...
    AddressV2 result = converter.transformTo(input);
  ...
  void shouldHandleRoundTripConversionCorrectly() {
    ...
    AddressV2 result = converter.transformTo(attributeValue);
  ...
  void shouldHandleNullAttributeValueInput() {
    AddressV2 result = converter.transformTo(null);
  ...
  void shouldHandleAddressWithPartialFields() {
    AddressV2 partialAddress = createPartialAddress();
  ...
  void shouldHandleAddressWithQuotedStrings() {
    AddressV2 quotedAddress = createAddressWithQuotes();
  ...
  void shouldReturnCorrectEnhancedType() {
    EnhancedType<AddressV2> result = converter.type();

    assertThat(result).isEqualTo(EnhancedType.of(AddressV2.class));
  }
  ...
  private AddressV2 createCompleteAddress() {
  ...
  private AddressV2 createPartialAddress() {
    AddressV2 address = new AddressV2();
  ...
  private AddressV2 createAddressWithQuotes() {
    AddressV2 address = new AddressV2();
  ...
  private void assertAddressFieldsMatch(AddressV2 actual, AddressV2 expected) {
