...
class TeamV2Test {
    ...
    void testEqualsAndHashCode() {
        TeamV2 sameTeam = TeamV2.builder()
                .id("team-123")
                .tenantId("tenant-456")
                .name("Engineering Team")
                .description("Core engineering team")
        ...
        TeamV2 differentTeam = TeamV2.builder()
                .id("team-999")
                .tenantId("tenant-456")
                .name("Marketing Team")
    ...
    void testToString() {
        ...
        assertThat(teamString).contains("TeamV2");
    ...
    void testBuilderWithAllFields() {
        TeamV2 fullTeam = TeamV2.builder()
                .tenantId("tenant-123")
                .name("Team Name")
